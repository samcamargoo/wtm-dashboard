...
export const Footer = () => {
  return (
    <>
      <div className="bg-cover bg-center bg-[url('/footer.svg')] flex  justify-center items-center min-h-[900px] relative">
        <div className="flex flex-col gap-2 text-white items-center z-10 w-full">
          ...
          <p className="text-[24px] font-thin">aqui não ignoramos ninguém</p>
        </div>

        <div className="absolute inset-0 bg-black opacity-30"></div>
      </div>
      <div className="flex w-full bg-black text-white px-32 gap-10 pb-20 pt-10">
