...
export const Hero = () => {
  ...
  return (
    <div
      className={`relative flex items-center h-[100dvh] bg-cover bg-center bg-[url('/background.svg')]`}
    >
      {!isAthlet && (
      ...
      {isAthlet && (
        <div className="flex flex-col px-32  gap-6 z-10">
          <div className="flex flex-col gap-2">
            <p className="text-[64px] text-white  leading-none font-light">
              Tenha sede de gol
            </p>
            <p className="text-[64px] text-white  leading-none font-light">
              E não apenas de cerveja.
            </p>
            <p className="font-light text-white">pare de assistir inovação e comece a fazer, mas  ao lado de quem bebe dessa água no café da manhã.</p>
          </div>
